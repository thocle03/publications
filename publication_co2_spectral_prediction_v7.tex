...
\author{Thomas~Clerc,~\IEEEmembership{Student Member,~IEEE,}
        and~Pierre~Six,~\IEEEmembership{Senior Member,~IEEE}%
\thanks{Thomas Clerc and Pierre Six are with the Department of Computer Science and Intelligent Systems, Ecole Hexagone, 75008 Paris, France (e-mail: thomas.clerc@ecole-hexagone.com, pierre.six@ecole-hexagone.com).}%
